  ...
  return (
    <View style={styles.tabBarContainer}>
      {tabs.map((tab, index) => {
        ...
        return (
          <TouchableOpacity key={tab.name} style={styles.tabItem} activeOpacity={0.7} onPress={() => handlePress(index, tab.route)}>
            {isActive ? (
              <LinearGradient colors={tab.gradient} style={styles.activeTabGradient} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }}>
  ...
  if (loading) {
    return (
      <View style={styles.loadingContainer}>
        <LinearGradient colors={['#1a1a2e', '#16213e']} style={styles.loadingGradient}>
